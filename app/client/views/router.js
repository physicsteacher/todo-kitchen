...
Router.map(function () {
	...
	this.route("todos", {path: "/todos", controller: "TodosController"});
	this.route("todos.insert", {path: "/todos/insert", controller: "TodosInsertController"});
	this.route("todos.edit", {path: "/todos/edit/:id", controller: "TodosEditController"});
